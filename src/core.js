...
import { camelToKebab, debounce, ECHARTS_SETTINGS, DEFAULT_COLORS } from './utils'
...
export default {
  ...
  computed: {
    ...
    chartColor () {
      return this.themeName ? this.echarts._theme.color : (this.colors || (this.theme && this.theme.color) || DEFAULT_COLORS)
    }
  },
  data () {
    return {
